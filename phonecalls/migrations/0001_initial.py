    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servicetype', models.IntegerField(choices=[(1, 'Serviços Básicos de Disponibilidade e Contact Center'), (2, 'Serviços de Comunicação'), (3, 'Serviços Diversos')], verbose_name='Tipo de Serviço')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('othertype', models.IntegerField(blank=True, choices=[(1, 'Serviços especializados de comunicação VoIP por demanda '), (2, 'Serviço de deslocamento para prestar serviço fora da Região Metropolitana de Fortaleza')], null=True, verbose_name='Tipo de Serviço Diverso')),
                ('basic_service', models.IntegerField(blank=True, null=True, verbose_name='Tipo de Serviço Básico')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['-startdate'], name='phonecalls_date_idx')],
            },
        ),
    ]
